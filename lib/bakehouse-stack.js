...
// ----------------------------------
    const githubOrg = props.githubOrg || 'andrewcorecom'
    const githubRepo = props.githubRepo || 'bakehouse-with-github-actions'
    ...
    const githubActionsDeployRole = new iam.Role(this, 'github-actions-deploy-role', {
      roleName: 'github-actions-andrew-milne-bakehouse',
